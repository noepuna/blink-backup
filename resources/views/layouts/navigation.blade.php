        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="url('orderhistory')" :active="request()->routeIs('orderhistory')">
                        {{ __('Order History') }}
                    </x-nav-link>

                    <x-nav-link :href="url('salehistory')" :active="request()->routeIs('salehistory')">
                        {{ __('Sale History') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="url('orderhistory')">
                    {{ __('Order History') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="url('salehistory')">
                    {{ __('Sales History') }}
                </x-responsive-nav-link>
